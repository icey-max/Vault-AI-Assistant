...
test("assistant chat view keeps required Phase 3 copy", () => {
  ...
  for (const text of [
    ...
    "vault-ai-assistant-message-stop",
...
test("assistant chat view keeps required Phase 3.5 chat action contract", () => {
  ...
  for (const text of [
    ...
    ".vault-ai-assistant-message-copy",
    ".vault-ai-assistant-message-stop",
    ".vault-ai-assistant-thinking",
    ".vault-ai-assistant-thinking-dots",
    ".vault-ai-assistant-thinking-dot",
    "vault-ai-assistant-thinking-pulse",
