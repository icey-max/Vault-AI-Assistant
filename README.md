...
| Editor Tab |
| --- |
| <img src="docs/assets/assistant-in-editorr.gif" alt="Vault AI Assistant running in the Obsidian sidebar" width="560"> |

<br>

| Side tab |
| --- |
| <img src="docs/assets/assistant-in-sidebar.gif" alt="Vault AI Assistant running in an Obsidian editor tab" width="360"> |
