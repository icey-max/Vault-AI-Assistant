...
| --- | --- |
| <img src="docs/assets/assistant-in-sidebar.gif" alt="Vault AI Assistant running in the Obsidian sidebar" width="360"> | <img src="docs/assets/assistant-in-editor.gif" alt="Vault AI Assistant running in an Obsidian editor tab" width="560"> |
